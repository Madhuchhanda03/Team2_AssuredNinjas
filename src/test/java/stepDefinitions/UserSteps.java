...
public void user_sends_a_get_request_to_endpoint(String endpoint) {
	...
	UserPayload upd = new UserPayload();
    try {
		response = upd.V2usersGetRequest("V2users");
	} catch (IOException e) {
...
public void validateStatusCode(int expectedStatus) {
	...
	//if (response == null) {
       // Assert.fail("Response is null. API call might have failed or the endpoint is incorrect.");
   // }
    //Assert.assertEquals(response.getStatusCode(), expectedStatus, "Incorrect status code!");
};
...
public void user_sends_a_get_request_to_endpoint_all_users() {
	...
	try {
		response = upd.V2usersGetRequest("allusers");
	} catch (IOException e) {
		// TODO Auto-generated catch block
		e.printStackTrace();
	}
...
public void the_api_endpoint_is_set_to_get_user_roles() {
	roleURL= "https://lms-hackthon-feb25-803334c87fbe.herokuapp.com/lms/users/roles";
...
public void the_api_endpoint_is_set_to_get_active_users() {
	ActiveURL = "https://lms-hackthon-feb25-803334c87fbe.herokuapp.com/lms/users/activeUsers";
    //userURL= "https://lms-hackthon-feb25-803334c87fbe.herokuapp.com/lms/users/activeUsers";
}

@When("a GET request is sent to fetch active users")
public void a_get_request_is_sent_to_fetch_active_users() {
	UserPayload upd = new UserPayload();
    response = upd.sendGetRequest(ActiveURL);
}
...
public void the_api_endpoint_is_set_to_get_all_roles() {
	allURL= "https://lms-hackthon-feb25-803334c87fbe.herokuapp.com/lms/roles";
...
public void the_api_endpoint_is_set_to_fetch_user_emails() {
	emailURL="https://lms-hackthon-feb25-803334c87fbe.herokuapp.com/lms/fetch-emails";
...
public void i_have_the_lms_api_endpoint_to_get_user_details() {
    useridURL = "https://lms-hackthon-feb25-803334c87fbe.herokuapp.com/lms/users/";
    }
...
public void user_creates_a_get_request_for_the_lms_api_program_batch_endpoint() {
   batchURL="https://lms-hackthon-feb25-803334c87fbe.herokuapp.com/lms/users/programBatch/6546";
...
public void given_The_Api_Endpoint_To_Fetch_User_Details_Is_Available() {
	detURL="https://lms-hackthon-feb25-803334c87fbe.herokuapp.com/lms/users/details/U37";
	//System.out.println("User creates a GET request for the LMS API Program user details endpoint with a valid token.");
}
...
public void user_creates_a_get_request_for_the_lms_api_users_by_status_endpoint() {
	allURL="https://lms-hackthon-feb25-803334c87fbe.herokuapp.com/lms/users/byStatus?id=all";
...
public void user_creates_put_request_for_the_LMS_API_endpoint() {
	idURL="https://lms-hackthon-feb25-803334c87fbe.herokuapp.com/lms/users/U37";
}
...
public void user_creates_put_request_for_the_endpoint() {
	idURL="https://lms-hackthon-feb25-803334c87fbe.herokuapp.com/lms/users/U53";
}
@When("Send a PUT request with invalid data")
 public void send_a_put_request_with_invalid_data() {
	List<Map<String, String>> lst = ExcelReader.getAllDataFromExcel(fileName, "invalid","User");
	UserPayload upd = new UserPayload();
...
public void i_have_the_api_endpoint_to_update_user_login_with_id() {
        usURL = "https://lms-hackthon-feb25-803334c87fbe.herokuapp.com/lms/users/userLogin/U37";
    }
   @When("I send a PUT request to update the user login status")
    public void i_send_a_put_request_to_update_the_user_login_status() {
   	...
   	public void the_response_should_contain_the_updated_user_login_status() {
   	    ...
   	    // Extract the response body and check for the expected updated user login status
   	    String responseBody = response.getBody().asString();
  ...
  @Given("I have the API endpoint to update role, program, and batch status for user ID")
    public void i_have_the_api_endpoint_to_update_role_program_and_batch_status_for_user_id() {
        proURL = "https://lms-hackthon-feb25-803334c87fbe.herokuapp.com/lms/users/roleProgramBatchStatus/U37";
    }
    ...
    public void i_have_the_api_endpoint_to_update_the_role_for_user_id() {
        tURL = "https://lms-hackthon-feb25-803334c87fbe.herokuapp.com/lms/users/roleId/";
    }
    ...
    public void i_have_the_api_endpoint_to_delete_user_with_id() {
        deURL = "https://lms-hackthon-feb25-803334c87fbe.herokuapp.com/lms/users/U37";
    }
